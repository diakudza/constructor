...
let blocks = {
    ...
    protichkaPodRezbu: {
        ...
        variables: "#111=0.8(DLINA FASKI POD REZBY);#32=0.1(OTKLONENIE OT DIAMETRA REZBY DLIA PROTOCHKI);#108=3.93(DIAMETR GLADKOI CASTI);",
    ...
    protochkaDoGoloviSK: {
        ...
        variables: "#108=3.93(DIAMETR GLADKOI CASTI);#105=0.2(RADIYS POD GOLOVOI);#31=0.25(OTKLONENIE DIAMETRA FASKI OT SK T300); ;",
